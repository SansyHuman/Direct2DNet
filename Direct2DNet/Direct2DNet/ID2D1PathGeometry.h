...
namespace Direct2DNet
{
    ...
    public:
        ...
        /// <exception cref="Direct2DNet::Exception::DxException">Thrown when the geometry sink
        /// for this path geometry is not opened.</exception>
        void AddLine(Direct2DNet::D2D1_POINT_2F point);
        ...
        void AddBezier(Direct2DNet::D2D1_BEZIER_SEGMENT bezier);
        ...
        void AddQuadraticBezier(Direct2DNet::D2D1_QUADRATIC_BEZIER_SEGMENT bezier);
        ...
        void AddArc(Direct2DNet::D2D1_ARC_SEGMENT arc);
