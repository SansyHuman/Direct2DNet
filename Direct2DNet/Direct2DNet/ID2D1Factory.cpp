...
namespace Direct2DNet
{
    ...
    Direct2DNet::ID2D1RoundedRectangleGeometry ^ID2D1Factory::CreateRoundedRectangleGeometry(Direct2DNet::D2D1_ROUNDED_RECT roundedRectangle)
    {
        return gcnew Direct2DNet::ID2D1RoundedRectangleGeometry(this, roundedRectangle);
    }

    Direct2DNet::ID2D1EllipseGeometry ^ID2D1Factory::CreateEllipseGeometry(Direct2DNet::D2D1_ELLIPSE ellipse)
    {
    ...
    Direct2DNet::ID2D1TransformedGeometry ^ID2D1Factory::CreateTransformedGeometry(Direct2DNet::ID2D1Geometry ^sourceGeometry, Direct2DNet::D2D1_MATRIX_3X2_F transform)
    {
