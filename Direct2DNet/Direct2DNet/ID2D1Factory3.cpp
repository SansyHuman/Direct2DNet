...
namespace D2DNet
{
    ...
    {
        ID2D1Factory3::ID2D1Factory3(Direct2DNet::D2D1_FACTORY_TYPE type, System::Guid guid)
            : Direct2DNet::ID2D1Factory2(type, guid)
        {
        ...
        ID2D1Factory3::ID2D1Factory3(
            ...
            System::Guid guid)
            : Direct2DNet::ID2D1Factory2(type, options, guid)
        {
